...
class TestEventPublishing:
    ...
    def test_publish_retrieval_completed_event(self, mock_connection):
        ...
        # Verify routing key
        assert call_args[1]["routing_key"] == "retrieval.completed"
    ...
    @patch("services.chat.app.chat_events.pika.BlockingConnection")
    def test_publish_query_received_event(self, mock_connection):
        """Test publishing QueryReceived event."""
        from services.chat.app.chat_events import publish_query_received_event
